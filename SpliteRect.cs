...
namespace PicSplit
{
    ...
    class SpliteRectGroup
    {
            ...
            int widthDest, int heightDest)
        {
            ...
            _widthNum = GetSplitSize(_widthSrc, _heightSrc, startX, startY, widthDest, heightDest, ref _listSplitRect);
        }
            ...
            int widthDest, int heightDest, ref List<Rectangle> listOut)
        {
            ...
            if (widthSrc - startX < widthDest || heightSrc - startY < heightDest)
                return 0;

            int x = startX;
            int y = startY + heightDest;
            int widthNum = (widthSrc - startX) / widthDest;
            while (true)
            {
                Rectangle rect = new Rectangle();
